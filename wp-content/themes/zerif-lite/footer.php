...
<footer id="footer" role="contentinfo">
    ...
    <div class="container">
        ...
        if (!empty($zerif_socials_facebook) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_dribbble) ||
            ...
            echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="https://www.reniec.gob.pe/portal/intro.htm" ' . $attribut_new_tab . ' rel="nofollow">Registro Nacional de Identificación y Estado Civil ® RENIEC</a></div>';
